...
For detailed instructions or questions, please consult the [official documentation](https://docs.protocol.art/.art-all-about-ens-mint).
...
By following these steps, you can easily configure and enjoy your .art domain with the eth.limo gateway, bringing your decentralized website to life. If you have any questions or need further assistance, refer to the [official documentation](https://docs.protocol.art/.art-all-about-ens-mint).
