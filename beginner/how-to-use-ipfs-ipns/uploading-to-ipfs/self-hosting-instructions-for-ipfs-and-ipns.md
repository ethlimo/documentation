...
4.  Navigate to your `index.html` file and select **Open**.
    ...
    ![Choose a file window open in IPFS desktop.](../../../.gitbook/assets/ipfs-self-hosting-01.png)
5. Click the triple dot menu on `index.html` and select **Share link**.
6.  Click **Copy** to copy the file's URL to your clipboard.

    ![Share files window in IPFS desktop.](../../../.gitbook/assets/ipfs-self-hosting-02.png)
...
![IPFS Desktop application showing the pinning option.](../../../.gitbook/assets/ipfs-self-hosting-03.png)
