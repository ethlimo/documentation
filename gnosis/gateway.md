...
The resolution process for `.gno` domains is identical to that of `*.eth.limo`, with initial resolution taking place on **Gnosis Mainnet**. Please consult the main gateway [documentation](../introduction/what-is-eth.limo/gateway-basics/README.md) for more information.