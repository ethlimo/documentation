...
[Filebase](https://filebase.com/) is an S3-compatible object storage platform with built-in IPFS pinning. Files uploaded to a Filebase IPFS bucket are automatically pinned with 3x replication, and the platform provides both a public IPFS gateway and dedicated gateways.
